...
"
  ...
  curl -X POST -A "Arena Broadcaster/0.0.1 tauri:2.2.5 os:windows as:admin" -H "Authorization: Bearer $API_TOKEN" -H "Content-Type: text/plain" -d "$PGN" \
...
function pushSingle() {
  ...
  curl -X POST -A "Arena Broadcaster/0.0.0 tauri:2.2.5" -H "Authorization: Bearer $API_TOKEN" -H "Content-Type: text/plain" -d "
[Event \"Game $n\"]
[White \"White $n\"]
[Black \"Black $n\"]
[Result \"*\"]
